...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail;
      this.node = jQuery("<li/>");
      image = jQuery("<button class='iframeOverlay' style='position:absolute;background:none;'></button><iframe class='image_picker_image'  scrolling=\"no\" seamless=\"seamless\"></iframe>");
