...
(function(a) {
    window.elFinder = function(b, c) {
            ...
            a.extend(a.ui.keyCode, {
                ...
                a.preventDefault(), d.exec("getfile").fail(function() {console.log(1);
                    d.exec("open")
                })
            }), this.shortcut({
                pattern: "enter",
            ...
            lang: "en",
            cssClass: "",
            commands: ["open", "reload", "home", "up", "back", "forward", "getfile", "quicklook", "download", "rm", "duplicate", "rename", "mkrule","mkfilter", "upload", "copy", "cut", "paste", "edit", "extract", "archive", "search", "info", "view", "help", "resize", "sort"],
            commandsOptions: {
                getfile: {
                    onlyURL: !0,
                    multiple: !1,
            ...
            contextmenu: {
                ...
                cwd: ["reload", "back", "|", "upload", "mkrule","mkfilter",  "paste", "|", "sort", "|", "info"],
            ...
            .i18.en = {
                ...
                messages: {
                    ...
                    errmkrule: 'Unable to create folder "$1".',
					errMkfilter: 'Unable to create folder "$1".',
        ...
        function(b) {
            ...
            return this.not(".elfinder-cwd").each(function() {
                ...
                b.dragUpload && (T[0].addEventListener("dragenter", function(a) {
                    ...
                    E()
                }).bind("mkrule mkfilter duplicate upload rename archive extract", function(c) {
                    var d = b.cwd().hash,
                        e;
        ...
        }, elFinder.prototype.commands.info = function() {console.log("ggg");
            var b = "msg",
                c = this.fm,
            ...
            this.tpl = {
                ...
                j == 1 ? (v = i[0], l = l.replace("{class}", f.mime2class(v.mime)), w = g.itemTitle.replace("{name}", v.name).replace("{kind}", f.mime2kind(v)), v.tmb && (u = f.option("tmbUrl") + v.tmb), v.read ? v.mime != "directory" || v.alias ? t = f.formatSize(v.size) : (t = g.spinner.replace("{text}", e.calc), p.push(v.hash)) : t = e.unknown,k.push(h.replace(m, "Type").replace(n,v.Type)), k.push(h.replace(m, e.size).replace(n, t)), v.alias && k.push(h.replace(m, e.aliasfor).replace(n, v.alias)), console.log(e),k.push(h.replace(m, e.path).replace(n, f.escape(f.path(v.hash)))), v.read && k.push(h.replace(m, e.link).replace(n, '<a href="' + f.url(v.hash) + '" target="_blank">' + v.name + "</a>")), v.dim ? k.push(h.replace(m, e.dim).replace(n, v.dim)) : v.mime.indexOf("image") !== -1 && (v.width && v.height ? k.push(h.replace(m, e.dim).replace(n, v.width + "x" + v.height)) : (k.push(h.replace(m, e.dim).replace(n, g.spinner.replace("{text}", e.calc))), f.request({
                    data: {
                        cmd: "dim",
                        target: v.hash
                    },
        ...
        }, elFinder.prototype.commands.mkrule = function() {
            this.disableOnSearch = !0, this.updateOnSelect = !1, this.mime = "directory", this.prefix = "untitled rule", this.exec = a.proxy(this.fm.res("mixin", "make"), this), this.shortcuts = [{
                pattern: "ctrl+shift+n"
            }], this.getstate = function() {
                return !this._disabled && this.fm.cwd().write ? 0 : -1
            }
        },elFinder.prototype.commands.mkfilter = function() {
            this.disableOnSearch = !0, this.updateOnSelect = !1, this.mime = "directory", this.prefix = "untitled filter", this.exec = a.proxy(this.fm.res("mixin", "make"), this), this.shortcuts = [{
                pattern: "ctrl+shift+n"
            }], this.getstate = function() {
                return !this._disabled && this.fm.cwd().write ? 0 : -1
            }
